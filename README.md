...
| Name                                                                                                                                              | Description                                                                                                                                                 | Keywords                                                           |
| ------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| [GenAI Conversational UI Patterns](https://github.com/nanlabs/frontend-reference/tree/main/examples/genai-conversational-ui-patterns)             | Design patterns for AI chat experiences: citations, personalization, privacy, accessibility, chunking, multimodality, memory, feedback, and errors.         | _GenAI_, _Chat_, _Conversational UI_, _UX Patterns_, _AI_          |
...
| [Nielsen Heuristics Evaluation Guide](https://github.com/nanlabs/frontend-reference/tree/main/examples/nielsen-heuristics-evaluation-guide)       | Score any interface against Jakob Nielsen's 10 usability heuristics with a practical 1-5 rubric for design reviews and QA.                                  | _Usability_, _Heuristics_, _UX_, _Accessibility_, _Best Practices_ |
| [Visual UI Code Generation Tools Matrix](https://github.com/nanlabs/frontend-reference/tree/main/examples/visual-ui-code-generation-tools-matrix) | When to use v0, Plasmic, Builder.io, or Locofy for design-to-code, with a comparative matrix and use-case recommendations.                                  | _Code Generation_, _Figma_, _v0_, _Prototyping_, _Best Practices_  |
